# asml-product-p8-controls — Product Spec (M0)

**Parent:** asml-bench [#50](https://github.com/gtmsko46-debug/asml-bench/issues/50)  
...
report = recover_from_glitch(tool_states=..., source_event=...)
```
...
| Frozen eval | product controls eval; FEL-06 / TH-07 feed when KEEP |
| Assumption card | `source-glitch-controls-v1` |
